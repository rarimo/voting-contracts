        ...
        assembly {
            ...
            function pRound(c0, c1, c2, c3, c4) {
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M40, F), mulmod(mload(0x120), M50, F), F),
                            mulmod(mload(0x140), M60, F),
                            F
                        ),
                        p,
                        F
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M41, F), mulmod(mload(0x120), M51, F), F),
                            mulmod(mload(0x140), M61, F),
                            F
                        ),
                        p,
                        F
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M42, F), mulmod(mload(0x120), M52, F), F),
                            mulmod(mload(0x140), M62, F),
                            F
                        ),
                        p,
                        F
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M43, F), mulmod(mload(0x120), M53, F), F),
                            mulmod(mload(0x140), M63, F),
                            F
                        ),
                        p,
                        F
                ...
                p := addmod(
                    addmod(
                        addmod(mulmod(state0, M04, F), mulmod(state1, M14, F), F),
                        mulmod(state2, M24, F),
                        F
                    ),
                    mulmod(state3, M34, F),
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M44, F), mulmod(mload(0x120), M54, F), F),
                            mulmod(mload(0x140), M64, F),
                            F
                        ),
                        p,
                        F
                ...
                p := addmod(
                    addmod(
                        addmod(mulmod(state0, M05, F), mulmod(state1, M15, F), F),
                        mulmod(state2, M25, F),
                        F
                    ),
                    mulmod(state3, M35, F),
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M45, F), mulmod(mload(0x120), M55, F), F),
                            mulmod(mload(0x140), M65, F),
                            F
                        ),
                        p,
                        F
                ...
                p := addmod(
                    addmod(
                        addmod(mulmod(state0, M06, F), mulmod(state1, M16, F), F),
                        mulmod(state2, M26, F),
                        F
                    ),
                    mulmod(state3, M36, F),
                ...
                mstore(
                    ...
                    addmod(
                        addmod(
                            addmod(mulmod(state4, M46, F), mulmod(mload(0x120), M56, F), F),
                            mulmod(mload(0x140), M66, F),
                            F
                        ),
                        p,
                        F
...

            {
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x2fa29bace00ac0dfacfd79691e1410a3a9544aeeefd8e467c188804a9216b8ca,
                            mulmod(state1, M10, F),
                            F
                        ),
                        mulmod(state2, M20, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x116bc44ec89691494126707cf0635682b39ff964c3c8aeb2c5814e0d16aa6d12,
                            mulmod(state1, M11, F),
                            F
                        ),
                        mulmod(state2, M21, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x1da55d8c9b9732ccafbf0050e362abb55c5ffb273ecee39e3e420385ca779922,
                            mulmod(state1, M12, F),
                            F
                        ),
                        mulmod(state2, M22, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x121540b4722a5beae6a95f858d78899b1727df4f887f48f06cf90bc90fb3a795,
                            mulmod(state1, M13, F),
                            F
                        ),
                        mulmod(state2, M23, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x3404a8f0340239753291f19b5f680a76f95bd3039fc47c23b5598cca873a03e,
                            mulmod(state1, M14, F),
                            F
                        ),
                        mulmod(state2, M24, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0x18893102b09655522ee1664290108b9522823061c33663036bbf541f8ce2a2ae,
                            mulmod(state1, M15, F),
                            F
                        ),
                        mulmod(state2, M25, F),
                ...
                p := addmod(
                    addmod(
                        addmod(
                            0xb694c6db328f9a5c78933ba3048632f45e33c7c0a5ab9b29750108a6f3a0993,
                            mulmod(state1, M16, F),
                            F
                        ),
                        mulmod(state2, M26, F),
