...
/**
 * @title IPoolRegistry Interface
 * @dev Interface for the PoolRegistry, responsible for managing pool pool implementations and instances.
 */
interface IPoolRegistry {
    /**
     * @notice Sets or upgrades the implementations for specified pool pool types.
     *
     * @dev Only callable by the owner. Ensures names and implementations arrays are of equal length.
     *
     * @param names_ Array of names associated with pool pool types.
     * @param newImplementations_ Array of addresses for the new implementations of the corresponding pool pool types.
     */
     ...
     *
     * @dev Only callable by the PoolFactory contract.
     *
